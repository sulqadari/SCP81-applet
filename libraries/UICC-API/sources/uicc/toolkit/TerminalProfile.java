...
public final class TerminalProfile {
	...
	/**
       ...
       */
        ...
        */
       public final static short IDX_MULTIPLE_ACCESS_TECHNOLOGIES_SUPPORT = (short)199;
       /**
        ...
        */
         ...
         */
        public static final short IDX_TERMINAL_APPLICATIONS =(short)234;
        /**
         * Proactive UICC: ACTIVATE = 236
         */
        public static final short IDX_PROACTIVE_UICC_ACTIVATE = (short)236;
        /**
         * Proactive UICC: PROVIDE LOCAL INFORMATION (Boradcast Network Informations)=238
         */
        public static final short IDX_PROACTIVE_UICC_PROVIDE_LOCAL_INFORMATION_BROADCAST_NETWORK =(short)238;
        /**
         * Proactive UICC: Contactless State Changed = 240
         */
        public static final short IDX_PROACTIVE_UICC_CONTACTLESS_STATE_CHANGED = (short)240;
        /**
         * Confirmation parameters supported for OPEN CHANNEL in Terminal Server Mode = 242
         * @deprecated 
         */
        public static final short IDX_OPEN_CHANNEL_COFIRMATION_PARAMETER = (short)242;
        /**
         * Confirmation parameters supported for OPEN CHANNEL in Terminal Server Mode = 242
         */
        public static final short IDX_OPEN_CHANNEL_CONFIRMATION_PARAMETER = (short)242;
        /**
         * Support of CAT over the modem interface (if class "s" is supported) = 244
         */
        public static final short IDX_CAT_SUPPORTED = (short)244;
        /**
         * Proactive UICC: Profile Container, Envelope Container, COMMAND CONTAINER and ENCAPSULATED SESSION CONTROL = 247;
         */
        public static final short IDX_CONTAINER_AND_SESSION_CONTROL = (short)247;
        /**
         * Launch parameter supported for OPEN CHANNEL in Terminal Server Mode = 251
         */
         public static final short IDX_LAUNCH_PARAMETERS_FOR_OPEN_CHANNEL = (short)251;
        /**
         * Direct communication channel supported for OPEN CHANNEL in Terminal Server Mode = 252;
         */
        public static final short IDX_DIRECT_COMMUNICATION_FOR_OPEN_CHANNEL = (short)252;
        /**
         * Proactive UICC: Security for Profile Container, Envelope Container, COMMAND CONTAINER and ENCAPSULATED SESSION CONTROL = 253
         */
        public static final short IDX_SECURE_CONTAINER_AND_SESSION_CONTROL = (short)253;
        /**
         * Support of refresh enforcement policy = 255
         */
        public static final short IDX_REFRESH_ENFORCEMENT_POLICY = (short)255;
        /**
         * Support for DNS server address request for OPEN CHANNEL for packet data service bearer = 256
         */
        public static final short IDX_DNS_SERVER_ADDRESS_OPEN_CHANNEL = (short)256;
        /**
         * Support of NEtwork Access Name reuse for CLOSE CHANNEL for packet data service bearer = 257
         */
        public static final short IDX_NETWORK_ACCESS_NAME_REUSE_CLOSE_CHANNEL = (short)257;
        /**
         * Event Poll Interval Negotiation support(i.e. class as is supported) = (short)258;
         */
        public static final short IDX_EVENT_POLL_INTERVAL_NEGOTIATION = (short)258;
        /**
         * Proactive UICC: PROVIDE LOCAL INFORMATION (Supported Radio Access Technologies) = (short)260;
         */
        public static final short IDX_PROVIDE_LOCAL_INFORMATION_SUPPORTED_RADIO_ACCESS_TECHNOLOGIES = (short)260;
		/**
		 * Support of Refresh eUICC Profile State Change = (short)269;
		 */
		public static final short IDX_REFRESH_eUICC_PROFILE_STATE_CHANGE = (short)269;
		/**
		 * Support of eUICC Profile Operation = (short)271;
		 * @deprecated
		 */
		public static final short IDX_REFRESH_eUICC_PROFILE_OPERATION = (short)271;
		/**
