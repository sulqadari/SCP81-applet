...
public interface ToolkitConstants {
	 ...
	 */
	 ...
	 final static short EVENT_EVENT_BROWSING_STATUS =(short)29;
         /**
	  * Event: Frames Information Changed = 31
	  */
         // event number 30 and 31 are reserved for 3GPP
	 //final static short EVENT_EVENT_DOWNLOAD_FRAMES_INFORMATION_CHANGED =(short)31;
     /**
	  * Event: Event HCI Connectivity = 32
	  */
	 final static short EVENT_EVENT_DOWNLOAD_HCI_CONNECTIVITY =(short)32;
      // event number 33 is reserved for 3GPP
     /**
	  * Event: Frames Information Changed = 34
	  */
	 final static short EVENT_EVENT_DOWNLOAD_FRAMES_INFORMATION_CHANGED =(short)34;
     /**
      * Event: Contactless State Request = 35
      */
     final static short EVENT_EVENT_DOWNLOAD_CONTACTLESS_STATE_REQUEST=(short)35;
     /**
      * Event: Poll Interval Negotiation = 36
      */
     final static short EVENT_EVENT_POLL_INTERVAL_NEGOTIATION=(short)36;

    // events 121,122 are reserved for 3GPP
	//
	 ...
	 */
	 final static short EVENT_REMOTE_FILE_UPDATE = (short)125;
	 ...
	 */
      ...
      */
     final static short EVENT_EVENT_DOWNLOAD_ACCESS_TECHNOLOGY_CHANGE_MULTIPLE = (short)128;
     /**
      *  Event: Memory Failure = 129
      */
     final static short EVENT_MEMORY_FAILURE = (short)129;
	 /**
	  * Event: Terminal Applications=130
	  */
	 final static short EVENT_TERMINAL_APPLICATIONS=(short)130;
	 /**
      * Event Terminal Capability command = 131
      */
    final static short EVENT_TERMINAL_CAPABILITY=(short)131; 
	
	/**
         * RFU: 38 to 118
         * RFU: 132 to 32767
         * Reserved for proprietary use (range for card manufacturers proprietary events): -2 to -64
         * Reserved for proprietary use (range for card issues proprietary events): -65 to -128
         * RFU: -129 to -32768
	 */
	/**
	...
	final static byte TAG_URL = (byte) 0x31;
         ...
         */
        final static byte TAG_URI = (byte)0x31;
	/**
	...
	final static byte TAG_BROWSER_TERMINATION = (byte) 0x34;
         ...
         */
        final static byte TAG_SUPPORTED_RADIO_ACCESS_TECHNOLOGIES = (byte)0x34;
	/**
	...
	final static byte TAG_DISPLAY_PARAMETERS = (byte) 0x40;
         ...
         */
        final static byte TAG_DNS_SERVER_ADDRESS = (byte)0x40;
	/**
	 ...
	 */
	 final static byte TAG_ITEM_TEXT_ATTRIBUTE_LIST=(byte)0x51;
         ...
         */
         final static byte TAG_CONTACTLESS_STATE_REQUEST=(byte)0x53;
	/**
	...
	final static byte PRO_CMD_DECLARE_SERVICE = (byte) 0x47;
         ...
         */
        final static byte PRO_CMD_ACTIVATE = (byte)0x70;
        /**
         * Type of proactive command: Contactless State Changed         = 0x71
         */
        final static byte PRO_CMD_CONTACTLESS_STATE_CHANGED = (byte)0x71;
