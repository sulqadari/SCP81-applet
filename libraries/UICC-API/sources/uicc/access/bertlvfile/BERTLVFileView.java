...
public interface BERTLVFileView extends FileView {
	 ...
	 *
	 * <li><em>If </em><code>tag</code><em> value is invalid or is equal to '5C', an
	 ...
	 *
	 * <li><em>If </em><code>mode</code><em> is </em><code>BER_TLV_ACC_MODE_FIRST</code><em> and </em><code>dataLength</code><em> is equal to 0, a zero length object is created.</em>
	 *
	 * <li><em>If </em><code>tag</code><em> value is invalid or is equal to '5C', an</em>
         * <code>UICCException</code><em> with reason code</em>
         * <code>INVALID_TAG_VALUE</code><em> is thrown</em>
	 * </ul>
	 *
