...
public interface FileView extends Shareable {
	 ...
	 * <p>
	 * Notes:<ul>
	 * <li><em>If </em><code>patOffset</code><em> or </em><code>pattLength</code><em> or </em><code>respOffset</code><em> or </em><code>respLength</code><em>parameter
	 * is negative an </em><code>ArrayIndexOutOfBoundsException</code><em> exception is thrown.</em>
	 ...
	 * <p>
	 * Notes:<ul>
	 * <li><em>If </em><code>incrOffset</code><em> or </em><code>incrLength</code><em> or </em><code>respOffset</code><em> parameter
	 * is negative an </em><code>ArrayIndexOutOfBoundsException</code><em> exception is thrown.</em>
