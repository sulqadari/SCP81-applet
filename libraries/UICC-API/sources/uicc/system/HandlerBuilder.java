...
public final class HandlerBuilder {
	 ...
	 *      <li><code>NO_RESOURCE</code> if there are not enough resources in the card to allocate the handler</li></ul>
         * @return a <code>ViewHandler</code> object
	 */
	 ...
	 * @param offset offset into the buffer indicating the start of the content that has to be copied into the internal buffer of the handler
	 ...
	 *      <li>if <code>offset</code> would cause access outside array bounds, or if <code>length</code> is negative.</li>
	 ...
	 *      <li><code>BAD_INPUT_PARAMETER</code> if <code>length</code> is greater than <code>capacity</code></ul>
         * @return a <code>ViewHandler</code> object
	 */
